...
public class Conexao {
  ...
  public Conexao() {
      try {
          ...
          connection = DriverManager.getConnection("jdbc:mysql://localhost" + "/consulta?useTimezone=true&serverTimezone=UTC", "root", "Jm!guel2004");
  ...
  public int retornaIDMax(String paciente) {
      try {
          String sql = "SELECT max(ID) as contador FROM " + paciente;
